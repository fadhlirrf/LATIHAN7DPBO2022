...
// No.1 --> tombol Add Menambahkan Data 
if(isset($_POST['add'])){
	$otask->addTask();
	header("location:index.php");
}

// No.2 --> tombol Hapus Menghapus Data
if(isset($_GET['id_hapus'])){
	$id = $_GET['id_hapus']; // tampung id
	$otask->delTask($id); // hapus berdasarkan id
	header("location:index.php");
}

// No.3 --> tombol selesai Mengubah Status 
if(isset($_GET['id_status'])){
	$id = $_GET['id_status']; // tampung id
	$otask->updateTask($id); // ubah status berdasarkan id
	header("location:index.php");
}
